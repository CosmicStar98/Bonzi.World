...
!*/
    ...
    $(function () {
        ...
        (BZWAgents.prototype.getAgent = function (name) {
            if (name) {
                return (
                    ["black", "grey", "white", "ghost", "blue", "cyan", "brown", "green", "lime", "purple", "magenta", "dark_purple", "red", "dark_red", "orange", "yellow", "lime", "pink", "god", "pope"].includes(name.toLowerCase()) && (name = "Bonzi"),
        ...
        (window.BonziHandler = new (function () {
            ...
            (this.framerate = 1 / 15),
                ...
                (this.prepSprites = function () {
                    for (const color of ["black", "grey", "white", "ghost", "blue", "cyan", "brown", "green", "lime", "dark_purple", "purple", "dark_red", "red", "orange", "yellow", "lemon", "pink", "pope", "god", "clippy", "f1", "genie", "genius", "links", "merlin", "peedy", "rocky", "rover"]) {
    ...
    var Bonzi = (function () {
        function Bonzi(id, userPublic) {
            ...
            _classCallCheck(this, Bonzi),
                (this.bounceColors = ["black", "grey", "white", "ghost", "blue", "cyan", "brown", "green", "lime", "dark_purple", "purple", "magenta", "dark_red", "red", "orange", "yellow", "lemon", "pink", "god",]),
                (this.availableColours = ["black", "grey", "white", "blue", "cyan", "brown", "green", "lime", "dark_purple", "purple", "magenta", "dark_red", "red", "orange", "yellow", "lemon", "pink", "god", "clippy", "f1", "genie", "genius", "links", "merlin", "peedy", "rocky", "rover"]),
                (this.overlayOffset = { left: 0, top: 0 }),
            ...
            (this.colorPrev = null),
              ...
              /*  this.$container.append(
               ...
               this.$container.append(
                ...
                $('#chat_log_status').text("| " + "BonziWORLD Version: " + window.bzw.version + " | " + "Socket ID: " + socket.id + " |"),
                        ...
                        return {
                            items: {
                                ...
                                uwu: {
                                    name: "Notice Bulge 2",
                                    callback: function () {
                                        socket.emit("command", { z: window.generateTSString(), list: ["uwu", _this2.userPublic.name] });
                                    },
                                },
                            },
                        };
                    ...
                    return {
                        items: {
                            ...
                            uwu: {
                                name: "Notice Bulge 2",
                                callback: function () {
                                    socket.emit("command", { z: window.generateTSString(), list: ["uwu", self.userPublic.name] });
                                },
                            },
                        },
                    };
                ...
                },
                {
                    ...
                    value: function () {
                        this.userPublic && this.userPublic.flags ? this.userPublic.flags && this.userPublic.flags.admin && this.$nameIcon.html("<i class='fas fa-gavel' title='Administrator' />") : this.$nameIcon.html(""),
                            ...
                            this.$nametag2.text(this.userPublic.name);
                    },
                },
                {
                    key: "updateStatus",
...
$('.bonzi_status:empty').css("display", "none"); 
                        ...
                        if (!this.mute) {
                            ...
                            self.$dialog.addClass("video-yt"),
                                ...
                                (self.player = new YT.Player(vcid, {
                                    ...
                                    playerVars: { autoplay: 0, modestbranding: 0, controls: 2 },
                                    events: {
                ...
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            var b = "embed";
                            this.$dialog.addClass('bubble_autosize');
                ...
                },
                {
                    ...
                    value: function (target, data) {
                        ...
                        this.runSingleEvent([
                            { type: "text", text: "*notices " + target + "'s BonziBulge™*", say: "notices " + target + "s bonzibulge", extra: namedExtra, audio: namedExtra.audio },
                            { type: "text", text: "♥ ( 。 U ω U 。 )<br/>uwu, wat dis? uwu", say: "uwu, what diss?", extra: commonExtra, audio: commonExtra.audio },
                        ]);
                    },
                },
                {
        ...
        $(function () {
            $("body").on("click", "#page_sidebar_close", function () {
                ...
                socket.on("ban", function (data) {
                    (window.banned = !0), (window.banData = data), (soundfx = new Audio("../../sfx/ban.wav")), soundfx.play(), $("#ban_reason").html(data.reason || "Being retarded? IDK. The fucker that banned you didn't specify.");
                ...
                socket.on("kick", function (data) {
                    (window.kicked = !0),
                        ...
                        $("#page_ban").hide(),
                        $("#page_kick").show(),
                        soundfx = new Audio("../../sfx/kick.wav");
                        soundfx.play()
...
/*
     FILE ARCHIVED ON 20:08:22 May 14, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 17:41:38 Jun 05, 2022.
...
/*
playback timings (ms):
  captures_list: 210.367
  exclusion.robots: 0.081
  exclusion.robots.policy: 0.075
  cdx.remote: 0.061
  esindex: 0.007
  LoadShardBlock: 160.368 (3)
  PetaboxLoader3.datanode: 97.258 (4)
  CDXLines.iter: 12.011 (3)
  load_resource: 72.43
  PetaboxLoader3.resolve: 32.657
*/
