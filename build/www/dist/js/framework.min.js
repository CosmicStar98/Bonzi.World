...
!*/
    ...
    $(function () {
        ...
        (BZWAgents.prototype.getAgent = function (name) {
            if (name) {
                return (
                    ["black", "grey", "white", "blue", "cyan", "brown", "green", "lime", "purple", "magenta", "dark_purple", "red", "dark_red", "yellow", "lime", "pink", "god", "pope"].includes(name.toLowerCase()) && (name = "Bonzi"),
        ...
        (window.BonziHandler = new (function () {
            ...
            (this.framerate = 1 / 15),
                ...
                (this.prepSprites = function () {
                    for (const color of ["black", "grey", "white", "blue", "cyan", "brown", "green", "lime", "dark_purple", "purple", "dark_red", "red", "yellow", "lemon", "pink", "pope", "god", "clippy", "f1", "genie", "genius", "links", "merlin", "peedy", "rocky", "rover"]) {
    ...
    var Bonzi = (function () {
        function Bonzi(id, userPublic) {
            ...
            _classCallCheck(this, Bonzi),
                (this.bounceColors = ["black", "grey", "white", "blue", "cyan", "brown", "green", "lime", "dark_purple", "purple", "magenta", "dark_red", "red", "yellow", "lemon", "pink", "god",]),
                (this.availableColours = ["black", "grey", "white", "blue", "cyan", "brown", "green", "lime", "dark_purple", "purple", "magenta", "dark_red", "red", "yellow", "lemon", "pink", "god", "clippy", "f1", "genie", "genius", "links", "merlin", "peedy", "rocky", "rover"]),
                (this.overlayOffset = { left: 0, top: 0 }),
